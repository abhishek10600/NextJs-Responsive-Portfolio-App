...
const About = () => {
    return (
        <div className="main md:h-[600px]" id={"About"}>
            ...
            <div className="container flex flex-col justify-center items-center md:flex md:flex-row md:w-[1320px] md:mx-auto md:py-4 md:px-4 md:gap-10 md:shadow-xl md:rounded-2xl">
